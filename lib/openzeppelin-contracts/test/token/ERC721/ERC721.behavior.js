const { BN, constants, expectEvent, expectRevert } = require('@openzeppelin/gmx-test-helpers');
...
function shouldBehaveLikeERC721 (errorPrefix, owner, newOwner, approved, anotherApproved, operator, other) {
  ...
  context('with minted tokens', function () {
    ...
    describe('safe mint', function () {
      ...
      describe('via safeMint', function () { // regular minting is tested in ERC721Mintable.gmx-test.js and others
