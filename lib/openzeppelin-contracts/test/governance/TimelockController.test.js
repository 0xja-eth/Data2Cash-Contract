const { BN, constants, expectEvent, expectRevert, time } = require('@openzeppelin/gmx-test-helpers');
      ...
      describe('execute', function () {
        ...
        describe('with scheduled operation', function () {
          ...
          it('revert if execution comes too early 2/2', async function () {
            ...
            await time.increaseTo(timestamp - 5); // -1 is too tight, gmx-test sometime fails
    ...
    describe('batch', function () {
      ...
      describe('execute', function () {
        ...
        describe('with scheduled operation', function () {
          ...
          it('revert if execution comes too early 2/2', async function () {
            const timestamp = await this.mock.getTimestamp(this.operation.id);
            await time.increaseTo(timestamp - 5); // -1 is to tight, gmx-test sometime fails
